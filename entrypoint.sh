...
DISPLAY=:1 DISPLAY=:1.0 google-chrome --no-sandbox --disable-gpu --hide-scrollbars --disable-notifications -disable-infobars --no-first-run  --user-data-dir=/tmp/test  --window-position=0,0 --window-size=1280,720 "--app=${1}"
